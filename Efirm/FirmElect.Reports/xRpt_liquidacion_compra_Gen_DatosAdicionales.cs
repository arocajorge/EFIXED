...
{
    public partial class xRpt_liquidacion_compra_Gen_DatosAdicionales : DevExpress.XtraReports.UI.XtraReport
    {
        public xRpt_liquidacion_compra_Gen_DatosAdicionales()
        {
            InitializeComponent();
        }
