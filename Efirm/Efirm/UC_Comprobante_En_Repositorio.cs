...
namespace Efirm
{
    public partial class UC_Comprobante_En_Repositorio : DevExpress.XtraEditors.XtraUserControl, IDisposable 
    {
        ...
        string patch = @"C:\Comprobantes EFIRM\Comprobantes Pendientes enviar";
                            ...
                            try
                            {
                                ...
                                else
                                {
                                    ...
                                    if (factBus.GrabarDB(Comprobante_Info, ref mensajeError))
                                    {
                                        ...
                                        tb_Comprobante_Bus bus_comprobante = new tb_Comprobante_Bus();
                                        Comprobante_Info.Nom_Contribuyente = InfoContribuyente.Nom_Contribuyente;

                                       // bus_comprobante.guardar_pdf(Comprobante_Info, patch);
