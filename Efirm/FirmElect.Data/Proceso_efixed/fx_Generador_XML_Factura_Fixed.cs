            ...
            try
            {
                ...
                using (Entity_conexion_efixed context = new Entity_conexion_efixed())
                {
                    ...
                    foreach (var item in facturas)
                    {
                        ...
                        myObject.infoFactura.razonSocialComprador = (item.Nombres.ToString()).Trim();
                        ...
                        foreach (var item_det in facturas_detalle)
                        {
                            ...
                            if (item_det.vt_detallexItems != null && item_det.vt_detallexItems != "")
                            {
                                fDetalle.detallesAdicionales = new List<facturaDetalleDetAdicional>();
                                fDetalle.detallesAdicionales.Add(new facturaDetalleDetAdicional
                                {
                                    nombre = "Detalle",
                                    valor = item_det.vt_detallexItems
                                }
                               );
                            }
                        ...
                        if (item.vt_Observacion != null && item.vt_Observacion != "")
                        {
                            if (myObject.infoAdicional==null)
                                myObject.infoAdicional = new List<facturaCampoAdicional>();
                                facturaCampoAdicional compoadicional = new facturaCampoAdicional();
                                compoadicional.nombre = "NOTA: ";
                                compoadicional.Value = item.vt_Observacion;
                                myObject.infoAdicional.Add(compoadicional);
